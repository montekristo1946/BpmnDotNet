...
1. На схеме может быть один.
2. Имеет несколько входов.
3. Имеет N количество выходов (выходы нужно программировать).
...
2. Входной шлюз имеет 1 вход и N выходов.
3. Выходной шлюз имеет N входов и 1 выходов.
4. Шлюз всегда дожидается завершение всех входных Flow.
...
1. Может быть несколько на схеме.
2. Имеет один вход.

## Sequence Flow

Это собственно стрелочка от блока к блоку. <br>
Id flow участвует в программировании geteway <br>

## Text annotation

Аннотация.<br>
Элемент в логике работы не участвует, только для вывода информации. <br>
