...
public class ServiceTaskBuilder : IBpmnBuild<ServiceTaskBuilder>
{
    ...
    public string Build()
    {
        ...
        _svgStorage.AppendLine(CreatePathTop(_color));
        _svgStorage.AppendLine(CreateCircleLow());
        _svgStorage.AppendLine(CreatePathLow(_color));
    ...
    private string CreateCircleLow()
    {
        return "<circle cx=\"5\" cy=\"5\" r=\"5\" transform=\"translate(11, 10)\" style=\"stroke-linecap: round; stroke-linejoin: round; stroke: none; stroke-width: 2px; fill: white;\"> </circle>";
    }

    private string CreatePathTop(string color)
    {
        var retPatch =
    ...
    public ServiceTaskBuilder AddChild(string childElement)
    {
        _childElements.Add(childElement);
        return this;
    }

    public ServiceTaskBuilder AddColor(string color)
    {
        _color = color;
        return this;
    }

    public ServiceTaskBuilder AddId(string id)
    {
        _id = id;
        return this;
    }

    public ServiceTaskBuilder AddPosition(int x, int y)
    {
        _xElement = x;
        _yElement = y;
        return this;
