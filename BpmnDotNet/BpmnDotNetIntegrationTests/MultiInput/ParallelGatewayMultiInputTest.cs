...
public class ParallelGatewayMultiInputTest: IDisposable
{
    private readonly IHost _host;
    private readonly IElasticClientSetDataAsync _elasticSetDataAsync;
    private IServiceScope? _scope;
    private readonly IBpmnHandler  _gatewayThrid;
    
    public ParallelGatewayMultiInputTest()
    {
        ...
        _gatewayThrid =  Substitute.For<IBpmnHandler>();
        _gatewayThrid.TaskDefinitionId.Returns("Gateway_3");
        _gatewayThrid.Description.Returns("Gateway_3 Test description");
        _gatewayThrid.ActivityHandlerAsync(Arg.Any<IContextBpmnProcess>(), Arg.Any<CancellationToken>())
            .Returns(callInfo => 
            {
        ...
        _host = Host.CreateDefaultBuilder()
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddScoped<IBpmnHandler>(p=>_gatewayThrid);
            })
            .UseSerilog()
            .Build();
    ...
    public async Task StartNewProcess_CheckServiceTaskMultiInput_Completed()
    {
        ...
        {
            IdBpmnProcess = "ParallelGatewayMultiInputTest",
